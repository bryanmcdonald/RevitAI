...
|-------------|--------------|-------|
| ~~`set_view_scale`~~ | ~~P2-08+~~ | **Implemented in P2-08.5** as `SetViewScaleTool` in `ViewTools/`. |
| ~~Create legend view~~ | ~~P2-01~~ | **Implemented in P2-08.5** as `CreateLegendTool` (via view duplication). |
| ~~Create callout view~~ | ~~P2-01~~ | **Implemented in P2-08.5** as `PlaceCalloutTool` (detail/section callouts). |
